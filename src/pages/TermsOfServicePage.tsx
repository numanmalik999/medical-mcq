...
<p>The Company is not responsible for the content of the Service's users. You expressly understand and agree that You are solely responsible for the Content and for all activity that occurs under your account, whether done by You or any third person using Your account.</p>
...
<p>The Company reserves the right, but not the obligation, to, in its sole discretion, determine whether or not any Content is appropriate and complies with these Terms, refuse or remove this Content. The Company further reserves the right to format and edit any Content and to change the order of any Content on the Service. If You post such objectionable Content, We may terminate Your account.</p>
<p>As the Company cannot control all content posted by users and/or third parties on the Service, you agree to use the Service at your own risk. You understand that by using the Service You may be exposed to content that You may find offensive, indecent, incorrect or objectionable, and You agree that under no circumstances will the Company be liable in any way for any content, including any errors or omissions in any content, or any loss or damage of any kind incurred as a result of your use of any content posted, transmitted or otherwise made available via the Service.</p>
  ...
  useEffect(() => {
    const fetchPageContent = async () => {
      ...
      if (error && error.code !== 'PGRST116') { // PGRST116 means no rows found
        ...
        toast({ title: "Error", description: "Failed to load Terms of Service content.", variant: "destructive" });
      } else if (data) {
